...
* I do not know it really, but you need to put a folder with the name "kernels" and make there the zhash.cl file in.
...
* For fun, change the BTG Wallet Adress to yours, you can find in the files. Just, for better feeling and so on. Later, you also need to do this here but with more comfort to expect.
* Then, start the "run.sh" from your Console out the XBTGPUARC Folder and the programm should make a connection to solo-btg.2miners.com Pool.
